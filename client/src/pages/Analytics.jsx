            ...
            <div className="mx-4 flex h-fit flex-col gap-4 rounded-md bg-gradient-to-br from-purple-100 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="my-4 w-full">
                        ...
                        <select id="period-select" value={period} onChange={(e) => {setPeriod(e.target.value);setLocationFilter('All');setMovieFilter('All');}} className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
